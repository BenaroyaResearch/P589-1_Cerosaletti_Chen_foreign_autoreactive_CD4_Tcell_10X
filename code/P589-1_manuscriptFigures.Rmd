...
```{r Figure2A, message=FALSE, warning=FALSE}
...
```{r Figure2B, message=FALSE, warning=FALSE}
...
# Figure 3
```{r Figure3ARight, cache = TRUE}
# Manuscript Figure 3A (right)
dotPlotDotSize <- 3.75
...
```{r combinedTregTconv_curated_dotplot_stairstep}
...
```{r combinedTregTconv_curated_grouped_dotplot}
...
```{r tregSignatures_load_and_subset}
...
```{r tregSignatures_perGene_heatmap}
...
```{r tregSignatures_perGene_bubbleplot}
...
```{r tregSignatures_moduleScore_summary}
...
```{r tregSignatures_perStimulation_variants}
...
```{r tregSignatures_combined_sourceAnnotated_dotplot}
...
```{r expandedNT_TregVsTconv_compute_and_plot}
...
```{r inverseSimpson_TregVsTconv_compute_and_plot}
