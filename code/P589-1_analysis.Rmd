...
cell_types.tmp <- c("Memory CD4 T cell", "cDC1", "Memory CD8 T cell", "Treg", NA)
...
```{r cellTypeAssignmentAlluvialPlot}
library(ggalluvial)
...
alluvialPlot.tmp <- ggplot(cellCounts.tmp,
  ...
  geom_alluvium(aes(fill = cellTypeLogNorm)) +
  geom_stratum() +
...
seuratTreg.tmp <- subset(seuratQCMergedCleanedDS, subset = cellType == "Treg")
